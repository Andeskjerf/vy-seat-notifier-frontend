...
export default function SelectedJourney({ journey, removeJourney }: SelectedJourneyProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <div onClick={() => removeJourney(journey)} id={`selected-delete-${journey.id}`} className='white-bg absolute x-remove elevation pointer-cursor'>
          x
        </div>
      </div>
    </>
